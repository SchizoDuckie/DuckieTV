  ...
  function(dialogs, $http) {
    ...
    var notifications = {
      '1.1.6': ['<li>Languages: (new) Greek, Turkish, Slovak and South African English.',
        ...
        '<li>SearchEngines: (fix) Katcr new domain (newkatcr.co), EzTVag new domain (eztv.re) and results, limetorrrents dl links, 1337x dl links, TPB (*0.org), TPB mirror resolver, RarBG details links.',
