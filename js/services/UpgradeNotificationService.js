    ...
    function(dialogs, $http, $q) {
        ...
        var notifications = {
            '1.1.6': ["<li>Languages: (new) Greek, Turkish, Slovak and South African English.",
                "<li>SearchEngines: (new) Add ETTV (ettv.tv), ETag (extratorrent.ag), IsoHunt2 (isohunt2.net), IdopeClone (idope.top).",
                "<li>SearchEngines: (del) Remove idope.",
                "<li>Standalone: (upgrade) NWJS 33.0 with Chromium 69 and Node 10.9.0",
