  ...
  function(dialogs, $http) {
    ...
    var notifications = {
      '1.1.6': ['<li>Languages: (new) Greek, Turkish, Slovak and South African English.',
        ...
        '<li>SearchEngines: (del) Katcr is broken, TorrentZ2 is gone, ETTV is gone, Zooqle is gone, RarBG is gone.',
        '<li>SearchEngines: (fix) EzTVag new domain (eztv.wf) and results, limetorrrents DL links and new domain, 1337x DL links, TPB (*0.org), TPB mirror resolver, torrentdownloads new domain, fix details link for Jackett indexers.',
