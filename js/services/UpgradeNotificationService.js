  ...
  function(dialogs, $http) {
    ...
    var notifications = {
      '1.1.6': ['<li>Languages: (new) Greek, Turkish, Slovak and South African English.',
        ...
        '<li>SearchEngines: (fix) EzTVag new domain (eztv.re) and results, limetorrrents DL links and new domain, 1337x DL links, TPB (*0.org), TPB mirror resolver, RarBG details links, torrentdownloads new domain, fix details link for Jackett indexers.',
