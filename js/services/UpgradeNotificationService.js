  ...
  function(dialogs, $http) {
    ...
    var notifications = {
      '1.1.6': [
        ...
        '<li>SearchEngines: (new) Add ETag (extratorrent.st), IsoHunt2 (isohunt.tv), TGx (torrentgalaxy.to), EXT (ext.to), KATws (kickass.ws), Knaben (knaben.org), TheRARBG (t-rb.org), Uindex(uindex.org), PiratesParadise (piratesparadise.org).',
