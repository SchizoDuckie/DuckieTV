    ...
    function(dialogs, $http, $q) {
        ...
        var notifications = {
            '1.1.4': ["<li>Images: (fix) switched to Fanart.tv for all images after Trakt.tv ended support",
                ...
                "<li>Standalone: (upgrade) nwjs 19.x chromium 55.x Node 7.3.x, (fix) linux minimize bug, (new) option to open add-new-torrent panel on torrentHost, (fix) linux and mac multy systray bug, (fix) defaults for first time users bug, (new) option to set the color of the system tray icon",
