    ...
    function(dialogs, $http, $q) {
        ...
        var notifications = {
            '1.1.4': ["<li>Images: switched to Fanart.tv for all images after Trakt.tv ended support",
                ...
                "<li>searchEngines: (fix) remove Strike, KAT and torrentz as they are gone, (new) add 1337x, IsoHunt, KATCr, TorrentDownloads, TorrentZ2, and Zooqle, (fix) bug in RarBG causing non-found results after 15 minutes, (fix) drop find random KAT mirror feature as rockaproxy is gone, (new) add 2160p search quality",
