...
.factory('CalendarEvents', function($rootScope, FavoritesService) {
    ...
    var service = {
        ...
        setDate: function(date, range) {
            ...
            // only change the date and fetch new events when the range has changed to prevent fetching data multiple times.
            if (!service.startDate || !service.endDate || (service.startDate.toDateString() != startDate.toDateString() && service.endDate.toDateString() != endDate.toDateString())) {
        ...
        setEvents: function(events) {
            events.map(function(event) {
                ...
                service.removeEpisodeFromCache(event.episodeID);
         ...
         */
        removeEpisodeFromCache: function(episodeID) {
            calendarEvents.map(function(eventList) {
