...
.controller('CalendarCtrl', ["$scope", "$rootScope", "$filter", "SettingsService",
 ...
 */
.controller('DisplayCtrl', ["$scope", "$rootScope", "$filter", "SettingsService",
    function($scope, $rootScope, $filter, SettingsService) {
 ...
 */
.controller('SettingsTorrentCtrl', ["$scope", "$rootScope", "SettingsService", "KickassMirrorResolver", "ThePirateBayMirrorResolver", "TraktTVv2",
 ...
 */
.controller('SettingsCtrl', ["$scope", "$rootScope", "$routeParams", "FavoritesService", "SettingsService", "KickassMirrorResolver", "TraktTVv2", "$filter",
    function($scope, $rootScope, $routeParams, FavoritesService, SettingsService, KickassMirrorResolver, TraktTVv2, $filter) {
