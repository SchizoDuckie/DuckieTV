...
.controller('SidepanelSerieCtrl', function($dialogs, FavoritesService, SceneNameResolver, EpisodeAiredService, TorrentDialog, uTorrent, $location, serie, episode, season, SidePanelState) {
