 ...
 */
.controller('errorDialogCtrl', ['$scope', '$filter', '$modalInstance', 'header', 'msg',
 ...
 */
.controller('waitDialogCtrl', ['$scope', '$filter', '$modalInstance', '$timeout', 'header', 'msg', 'progress',
    function($scope, $filter, $modalInstance, $timeout, header, msg, progress) {
        //-- Variables -----//
...
.factory('$dialogs', ['$modal',
    function($modal) {
        return {
            ...
            confirmAll: function(header, msg, isStatic) {
                return $modal.open({
