/*!
 * angular-translate - v2.4.2 - 2014-11-23
...
angular.module("pascalprecht.translate", ["ng"]).run(["$translate",
    ...
    function(a) {
        ...
        this.storageKey = H, this.useUrlLoader = function(a, b) {
            ...
            function(a, c, i, r) {
                var x, z, I, J = c.get(k || "$translateDefaultInterpolation"),
                    K = !1,
                    L = {},
                    M = {},
                    N = function(a, c, e) {
                ...
                if (N.preferredLanguage = function(a) {
                    ...
                    for (var _ = function(a) {
                        D(a.key, a.table), i.$emit("$translateChangeEnd", {
                            language: a.key
                        })
        ...
        return {
            ...
            compile: function(b, g) {
                ...
                return function(b, l, m) {
                    ...
                    var n = {},
                        o = function(a) {
                            if (angular.equals(a, "") || !angular.isDefined(a)) {
                                ...
                                angular.isArray(d) ? (b.preText = d[1], b.postText = d[3], n.translate = c(d[2])(b.$parent)) : n.translate = l.text().replace(/^\s+|\s+$/g, "")
                            } else n.translate = a;
                            t()
                        },
                        p = function(a) {
                    ...
                    for (var q in m) m.hasOwnProperty(q) && "translateAttr" === q.substr(0, 13) && p(q);
                    if (m.$observe("translateDefault", function(a) {
                        b.defaultText = a
                        ...
                        for (var s in m) Object.prototype.hasOwnProperty.call(m, s) && "translateValue" === s.substr(0, 14) && "translateValues" !== s && r(s)
                    }
                    var t = function() {
                            for (var a in n) n.hasOwnProperty(a) && n[a] && u(a, n[a], b, b.interpolateParams)
                        },
                        u = function(b, c, d, e) {
